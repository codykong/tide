...
/**
  ...
  * Date: 2017/8/2 
  */
abstract class ProximityDistributionStrategy(logicalReceivers: List[String]) extends DistributionStrategy{

  val receivers : mutable.HashMap[String,List[String]] = initLogicalReceivers(logicalReceivers)
  /**
  ...
  /**
    ...
    * @return
    */
  private def initLogicalReceivers(logicalReceivers : List[String]) : mutable.HashMap[String,List[String]] = {
    val receiversMap : mutable.HashMap[String,List[String]] =new mutable.HashMap()
